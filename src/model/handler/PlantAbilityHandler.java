...
public class PlantAbilityHandler {
    ...
    public void spawnBulletsForPlant(Plant plant, Game game) {
        ...
        if (name.equalsIgnoreCase("Threepeater")) {
            game.addBullet(new Bullet(dmg, py, px + 1, Bullet.BulletType.NORMAL, false, false, 0));
            if (py > 0) game.addBullet(new Bullet(dmg, py - 1, px + 1, Bullet.BulletType.NORMAL, false, false, 0));
            if (py < game.getBoard().getRows() - 1) game.addBullet(new Bullet(dmg, py + 1, px + 1, Bullet.BulletType.NORMAL, false, false, 0));
        } else if (name.equalsIgnoreCase("Split Pea")) {
            game.addBullet(new Bullet(20, py, px + 1, Bullet.BulletType.NORMAL, false, false, 0));
            game.addBullet(new Bullet(20, py, Math.max(0, px - 1), Bullet.BulletType.NORMAL, false, false, 0));
            game.addBullet(new Bullet(20, py, Math.max(0, px - 1), Bullet.BulletType.NORMAL, false, false, 0));
        } else if (name.equalsIgnoreCase("Snow Pea")) {
            game.addBullet(new Bullet(20, py, px + 1, Bullet.BulletType.ICE, false, false, 0));
            ...
            game.addBullet(cactusBullet);
        } else if (name.equalsIgnoreCase("Goo Peashooter")) {
            game.addBullet(new Bullet(20, py, px + 1, Bullet.BulletType.POISON, false, false, 0));
            ...
            game.addBullet(new Bullet(bulbDmg, py, px + 1, Bullet.BulletType.NORMAL, true, true, 1));
