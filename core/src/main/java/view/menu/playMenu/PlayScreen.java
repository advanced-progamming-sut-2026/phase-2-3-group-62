...
import view.menu.seedChooser.CouchPlaySeedChooserScreen;
...
public class PlayScreen implements Screen {
    ...
    public void show() {
        ...
        AudioManager.getInstance().playTitleMusic();
    ...
    private void buildUI() {
        ...
        Table multiplayerBtn = createNavButton(
            ...
            new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    AudioManager.getInstance().playButtonClick();
                    new IZombieMultiplayerDialog(game, controller, skin, stage).show();
                }
            }
        );
        bottomLeft.add(multiplayerBtn).padRight(16);

        Table couchPlayBtn = createNavButton(
            ...
            new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    AudioManager.getInstance().playButtonClick();
                    changeScreenWithTransition(new CouchPlaySeedChooserScreen(game, controller, skin));
                }
            }
        );
        bottomLeft.add(couchPlayBtn).padRight(16);
