...
public class RegisterScreen implements Screen {
    ...
    public void show() {
        ...
        roundedBrownBgTexture = createRoundedRectangleTexture(820, 690, 24, new Color(0.18f, 0.11f, 0.06f, 0.96f));
    ...
    private void buildUI() {
        ...
        formTable.top().pad(20, 36, 20, 36);

        Label titleLabel = new Label("REGISTER", skin, "big_outline");
        titleLabel.setFontScale(1.35f);
        formTable.add(titleLabel).padBottom(2).colspan(2).center().row();
        ...
        formTable.add(networkStatusLabel).padBottom(6).colspan(2).center().row();

        statusLabel = new Label("", skin, "big");
        statusLabel.setFontScale(0.8f);
        statusLabel.setColor(Color.RED);
        formTable.add(statusLabel).padBottom(8).colspan(2).center().row();
        ...
        formTable.add(btnTable).colspan(2).padTop(10).center().row();

        boxStack.add(formTable);
        centerWrapper.add(boxStack).size(820, 690);
    ...
    private void addFormField(Table table, String labelText, Actor fieldActor) {
        ...
        table.add(label).right().padRight(12).padBottom(5);
        table.add(fieldActor).width(360).height(38).left().padBottom(5).row();
    }
