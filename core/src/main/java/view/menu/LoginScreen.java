...
public class LoginScreen implements Screen {
    ...
    public void show() {
        ...
        roundedBrownBgTexture = createRoundedRectangleTexture(640, 520, 24, new Color(0.18f, 0.11f, 0.06f, 0.96f));
    ...
    private void buildUI() {
        ...
        formTable.top().pad(30, 40, 30, 40);

        Label titleLabel = new Label("LOGIN", skin, "big_outline");
        titleLabel.setFontScale(1.35f);
        formTable.add(titleLabel).padBottom(10).colspan(2).center().row();

        statusLabel = new Label("", skin, "big");
        statusLabel.setFontScale(0.8f);
        statusLabel.setColor(Color.RED);
        formTable.add(statusLabel).padBottom(12).colspan(2).center().row();
        ...
        centerWrapper.add(boxStack).size(640, 520);
