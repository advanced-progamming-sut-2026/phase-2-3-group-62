...
public class MultiplayerDialogHelper {
    private final Maini game;
    private final Stage stage;
    private final Skin skin;
    private final Texture dimTexture;

    public MultiplayerDialogHelper(Maini game, Stage stage, Skin skin, Texture dimTexture) {
        this.game = game;
        this.stage = stage;
        this.skin = skin;
    ...
    public void showLeaveDialog(Runnable onConfirmLeave) {
        ...
        Label msg = new Label("Are you sure you want to leave the game?\nLeaving will count as an immediate defeat!", skin, "big");
        ...
        MultiplayerHud.attachHoverEffect(yesBtn, 1.08f);
        ...
        MultiplayerHud.attachHoverEffect(noBtn, 1.08f);
    ...
    public void showEndGameDialog(String message, boolean won, MenuController controller) {
        ...
        Label endTitle = new Label(won ? "VICTORY!" : "GAME OVER", skin, "big_outline");
        endTitle.setColor(won ? Color.GREEN : Color.RED);
        ...
        MultiplayerHud.attachHoverEffect(returnBtn, 1.08f);
